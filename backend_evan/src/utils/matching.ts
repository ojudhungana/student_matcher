import type { Year, CommuterStatus } from '../types.js';
...
export type MeInput = CandidateInput;
...
export function scoreCandidate(me: MeInput, other: CandidateInput): number {
  let score = 0;
  if (me.major && other.major && me.major === other.major) score += 3;
  if (me.year && other.year && me.year === other.year) score += 2;
  if (me.commuter_status && other.commuter_status && me.commuter_status === other.commuter_status) score += 1;
