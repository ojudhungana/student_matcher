...
export function MatchScreen() {
  ...
  if (!loading && !currentMatch && suggestions.length === 0) {
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <div className="bg-white border-b border-secondary-200 p-3 dark:bg-secondary-900 dark:border-secondary-700">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="text-center max-w-sm">
            <div className="mb-6">
              ...
              <div className="bg-secondary-50 dark:bg-secondary-800 rounded-lg p-3 mb-4">
  ...
  return (
    <motion.div
      ...
      className="flex flex-col min-h-screen bg-secondary-50 dark:bg-secondary-900"
    >
      <motion.div
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.4, delay: 0.1 }}
        className="bg-white shadow-sm border-b border-secondary-200 p-4 dark:bg-secondary-900 dark:border-secondary-700 dark:text-secondary-50"
      >
        <h1 className="text-xl font-semibold text-center">Discover People</h1>
      </motion.div>
      ...
      <motion.div
        ...
        className="bg-white border-b border-secondary-200 p-3 dark:bg-secondary-900 dark:border-secondary-700"
      >
      ...
      <div className="flex-1 flex flex-col pb-24">
        ...
        <motion.div
          ...
          className="fixed bottom-20 left-0 right-0 p-4 bg-white/95 backdrop-blur-sm border-t border-secondary-200 dark:bg-secondary-900/90 dark:border-secondary-700"
        >
          <div className="max-w-sm mx-auto">
            <motion.div
              initial={{ opacity: 0 }}
            ...
            <div className="flex items-center justify-center space-x-16">
              ...
              >
                <Button
                  ...
                  variant="secondary"
                  size="lg"
                  className="h-16 w-16 rounded-full p-0 shadow-lg bg-white dark:bg-secondary-800 border-2 border-red-200 hover:border-red-300"
